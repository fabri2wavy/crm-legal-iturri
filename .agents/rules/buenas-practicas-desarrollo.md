...
Enfoque Data-Heavy: Asume que las tablas y listas renderizarán grandes volúmenes de texto (jerga legal). Implementa truncamiento inteligente (text-overflow: ellipsis) con tooltips, o paginación/virtualización por defecto en listas largas.
